...
namespace GroceryStore.Core.Utilities
{
    public class SQLQueries
    {
        ...
        public static string get_products_query = "SELECT P.PRODUCTID, P.NAME, P.PRICE, P.QUANTITY, P.CATEGORY, PATH, COALESCE(C.QUANTITY, 0) AS PRODUCTQUANTITY FROM STS892_PRODUCTS P LEFT JOIN STS892_CART C ON P.PRODUCTID = C.PRODUCTID AND USERID = @USERID;";
